...
NUM_TESTS=4
RES_DIR="./ddp_test_sections_results"
WORLD_SIZE=8
TORCH_PORT=12321
...
do
   ...
   # launch the training
   TRAIN_CMD="examples/fault_tolerance/train_ddp_sections_api.py "
   ...
   assert_log_contains "${RES_DIR}/output_$i/log.log" "Updated section timeouts"
