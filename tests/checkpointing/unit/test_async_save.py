...
class TestAsyncSave:
    ...
    def test_persistent_async_cp_abort(self, tmp_path_dist_ckpt):
        ...
        with (
            ...
            assert async_process is not None, "After a valid CP save, we expect async process to be running"
            ...
            if async_process is not None:
                assert async_process._debug_is_async_process_running() is False, "After abort async process stops"
