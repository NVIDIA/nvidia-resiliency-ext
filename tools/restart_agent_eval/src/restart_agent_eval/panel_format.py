...
def _claim_confidence_label(value: Any, status: Any, confidence: Any) -> str:
    """Render confidence only for a substantive recovery claim."""

    if value == "unknown" or status == "unknown":
        return "N/A"
    return _md(confidence)
