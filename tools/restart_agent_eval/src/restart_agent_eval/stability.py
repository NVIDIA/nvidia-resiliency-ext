...
def _sample_from_row(
    ...
    return {
        ...
        "tool_exact_no_new_line_calls": row.get("l1_kpi_tool_exact_no_new_line_calls"),
        "tool_semantic_new_evidence_calls": row.get("l1_kpi_tool_semantic_new_evidence_calls"),
        "tool_semantic_no_new_evidence_calls": row.get(
            "l1_kpi_tool_semantic_no_new_evidence_calls"
        ),
        "tool_semantic_novelty_unassessed_calls": row.get(
...
def _summarize_cohort(
    ...
    return {
        ...
        "behavioral_variability": {
            ...
            "tool_exact_no_new_line_calls": _numeric_metrics(
                [sample.get("tool_exact_no_new_line_calls") for sample in ordered]
            ),
            "tool_semantic_new_evidence_calls": _numeric_metrics(
                [sample.get("tool_semantic_new_evidence_calls") for sample in ordered]
            ),
            "tool_semantic_no_new_evidence_calls": _numeric_metrics(
                [sample.get("tool_semantic_no_new_evidence_calls") for sample in ordered]
            ),
            "tool_semantic_novelty_unassessed_calls": _numeric_metrics(
                [sample.get("tool_semantic_novelty_unassessed_calls") for sample in ordered]
            ),
