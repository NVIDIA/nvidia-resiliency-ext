...
def _comparison_axes(rows: list[dict[str, Any]]) -> dict[str, list[dict[str, Any]]]:
    ...
    for row in rows:
        ...
        deterministic_only = not row.get("l1_output_usable")
        model_contribution = "deterministic_only" if deterministic_only else "model_enriched"
        ...
        route_outcome.append(
            {
                ...
                "reason": "no_model_enrichment" if deterministic_only else "model_enriched",
...
def _panel_row_l2_l3_l4_fields(state: _PanelRowState) -> dict[str, Any]:
    ...
    selected_budget = _dict(state.l4_kpis.get('selected_rule_budget'))
    return {
        ...
        'l4_general_root_matching_prior_failures': general_ceiling.get('matching_prior_failures'),
        ...
        'l4_selected_rule_budget_present': bool(selected_budget),
        'l4_selected_rule_budget_rule': selected_budget.get('rule'),
        'l4_selected_rule_budget_scope': selected_budget.get('history_match_scope'),
        'l4_selected_rule_allowed_retries': selected_budget.get('allowed_retries'),
        'l4_selected_rule_matching_prior_failures': selected_budget.get('matching_prior_failures'),
        'l4_selected_rule_observed_advance': selected_budget.get('observed_advance'),
        'l4_selected_rule_exhausted': selected_budget.get('exhausted'),
        ...
        'l4_declared_recovery_capability_ids': state.l4_kpis.get('declared_recovery_capability_ids')
        or [],
        'l4_applied_recovery_capability': state.l4_kpis.get('applied_recovery_capability'),
