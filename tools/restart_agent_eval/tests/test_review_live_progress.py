...
class ReviewLiveProgressTest(unittest.TestCase):
    ...
    def test_should_format_every_lifecycle_event_and_unknown_event(self) -> None:
        cases = {
            "deterministic_recommendation_ready": (
                "live: deterministic recommendation ready decision=RESTART"
            ),
        ...
        payloads = {
            "deterministic_recommendation_ready": {"decision": "RESTART"},
