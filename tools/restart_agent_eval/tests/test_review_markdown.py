...
class ReviewMarkdownTest(unittest.TestCase):
    def test_review_markdown_publishes_core_route_outcome(self) -> None:
        ...
        summary = {
            ...
            "l4_kpis": {
                ...
                "base_rule": policy["base_rule"],
                "effective_policy": policy["effective_policy"],
                "general_root_ceiling": policy["general_root_ceiling"],
                "selected_policy_ledger": policy["selected_policy_ledger"],
                "job_no_progress_guard": policy["job_no_progress_guard"],
                "job_unknown_progress_guard": policy["job_unknown_progress_guard"],
                "retry_budget_exhausted": policy["retry_budget_exhausted"],
                "current_affected_entity": {
                    "kind": "artifact",
                    "identity": "/checkpoints/iter_5000/metadata",
                    "fingerprint": "affected_entity:artifact:checkpoint-metadata",
                },
            },
            "primary_failure": {"failure_class": "checkpoint_read", "line": 12},
            ...
            "errors": [],
            "semantic_comparison": {
                "root_cause_status": "supported_but_unconfirmed",
                "failure_domain": {
                    "value": "unknown",
                    "status": "unknown",
                    "confidence": 50,
        ...
        self.assertIn("scope=`root_and_entity`", rendered)
        self.assertIn(
            "affected_entity=`artifact:/checkpoints/iter_5000/metadata`",
            rendered,
        )
        self.assertIn("- primary: `checkpoint_read` line `12`", rendered)
        self.assertIn("domain_confidence=`N/A`", rendered)
        self.assertIn("retry_confidence=`N/A`", rendered)
        self.assertIn("## Artifact Guide", rendered)
        self.assertIn("Complete L1 assessment, L2 grounding", rendered)
        self.assertNotIn("## L1 Model Output", rendered)
        self.assertNotIn('"justification": "The checkpoint read failed."', rendered)
    ...
    def test_review_markdown_renders_stage_kpis_gold_and_diagnostics(self) -> None:
        ...
        summary["primary_failure"]["affected_entity"] = {
            "kind": "artifact",
            "identity": "/checkpoints/iter_5000/metadata",
            "fingerprint": "affected_entity:artifact:abc",
            "evidence_line": 12083,
        }
