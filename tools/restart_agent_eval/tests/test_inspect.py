...
class TraceInspectionTest(unittest.TestCase):
    ...
    def test_should_report_compact_decision_evidence_projection_in_comparison_view(self) -> None:
        decision_evidence = {
            ...
            "analyzer_trace": {
                ...
                "l0_model_view": {
                    ...
                    "decision_evidence_view": {
                        "source_schema_version": "restart_agent_decision_evidence.v1",
                    },
                    "evidence_bundle": {"context_windows": []},
                    "projection_metrics": {},
                },
        ...
        self.assertEqual(
            comparison["decision_evidence"],
            {
                ...
                "compact_projection_present_in_model_view": True,
                "projection_source_schema_version": ("restart_agent_decision_evidence.v1"),
                "projection_identity_consistent": True,
            },
        )
