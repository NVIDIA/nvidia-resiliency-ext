...
def rich_route_summary() -> dict:
    affected_entity = {
        "kind": "artifact",
        "identity": "/lustre/checkpoints/iter_5000/metadata",
        "fingerprint": "affected_entity:artifact:1234567890abcdef",
        "evidence_line": 12083,
    }
    summary = {
        "target": "qwen235b",
        ...
        "retry_policy": {
            **retry_policy(
            ...
            "current_affected_entity": affected_entity,
        },
        "primary_failure": {
        ...
        "later_progress_after_fault_observations": [
            {
                "failure_class": "filesystem_access_error",
        ...
        "l2_kpis": {
            ...
            "recovery_assessment_audited": True,
            "finding_count": 0,
        ...
        "l4_kpis": {
            ...
            "nvrx_use": "eligible",
            "evidence_source": "l1_model_grounded",
