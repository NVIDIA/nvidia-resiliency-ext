...
Gold scoring keeps L1 RCA, L1 recovery semantics, L2 root/entity history
identity, final cascade grouping, and L4 policy/action as independent outcomes. L2 identity
...
5. Score deterministic and L1-enriched L4 paths independently.
