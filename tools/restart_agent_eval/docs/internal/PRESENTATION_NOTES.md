...
| --- | --- | --- |
| `overview()` | Return log structure, metadata, and progress summary. | off; L0B already provides initial orientation |
...
| `get_evidence_objects(ids)` | Fetch retained typed L0A evidence by reference. | on for tool-enabled routes |
