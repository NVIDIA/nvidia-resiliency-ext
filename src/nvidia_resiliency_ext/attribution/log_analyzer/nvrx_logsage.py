...
from logsage.auto_resume_policy.error_extraction import return_application_errors, return_application_errors, \
...
class NVRxLogAnalyzer(NVRxAttribution):
    ...
    async def llm_analyze_rt(self, rt_result: ErrorAttribution | None) -> list[str]:
        if rt_result is None:
            return []
        return [(
            rt_result.auto_resume,
            rt_result.auto_resume_verbose,
