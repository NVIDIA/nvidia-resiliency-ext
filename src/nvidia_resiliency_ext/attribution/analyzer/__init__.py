...
- :mod:`nvidia_resiliency_ext.attribution.svc.log_analyzer` — LogSage :class:`~nvidia_resiliency_ext.attribution.svc.log_analyzer.LogAnalyzer`
...
- :mod:`nvidia_resiliency_ext.attribution.svc.analysis_pipeline` — :func:`run_attribution_pipeline`,
  :class:`AnalysisPipelineMode`
- :mod:`nvidia_resiliency_ext.attribution.svc.types` — :class:`LogAnalyzerConfig`, result dataclasses

The sibling :mod:`nvidia_resiliency_ext.attribution.svc` package holds parsers,
